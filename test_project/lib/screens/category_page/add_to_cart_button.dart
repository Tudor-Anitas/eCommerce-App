  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: MaterialButton(
          color: provider!.shoppingCart.keys.contains(widget.currentItem.id)
              ? Theme.of(context).toggleableActiveColor
              : Theme.of(context).backgroundColor,
          onPressed: () {
            if (!provider!.shoppingCart.keys.contains(widget.currentItem)) {
          ...
          child: Row(
            ...
            children: [
              Icon(
                provider!.shoppingCart.keys.contains(widget.currentItem)
                    ? Icons.done
